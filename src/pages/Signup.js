  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-emerald-50 dark:from-zinc-950 dark:via-zinc-900 dark:to-zinc-950 relative overflow-hidden">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-20 left-20 w-40 h-40 bg-emerald-500/20 rounded-full blur-3xl float-animation" />
        <div className="absolute bottom-20 right-20 w-36 h-36 bg-purple-500/20 rounded-full blur-3xl float-animation" style={{ animationDelay: '1s' }} />
      </div>
        ...
        <div className="w-full max-w-md">
          <div className="glass p-8 rounded-3xl slide-in">
            <div className="text-center mb-8">
              <h1 className="text-4xl font-bold mb-2 text-gradient">Join UniBuddy</h1>
            ...
            <p className="text-center mt-6 text-sm text-muted-foreground">
              ...
              <Link to="/login" className="text-purple-600 dark:text-purple-400 font-medium hover:underline" data-testid="login-link">
                Login
              </Link>
            </p>
          </div>
